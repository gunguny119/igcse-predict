...
<template>
  <div v-show = "!clicked"> 
    ...
    <v-select v-model = "selected_topics" multiple :options="topic_list"></v-select>
    <button class="generate-button" @click = "onGeneratePaper">Generate Paper</button>
  ...
  <div v-show = "clicked">
    ...
    <p>sampled topics : {{returned_topics}}</p>
...
export default {
  ...
  methods : {
    ...
    sendRequest: async function (){
      ...
      this.returned_topics = data.topics;
